...
angular.module('dndLists', [])
   ...
   *                      his mouse pointer.
   */
  .directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround', '$window', 'dndDragFrom',
                      function ($parse, $timeout, dndDropEffectWorkaround, dndDragTypeWorkaround, $window, dndDragFrom) {
                      	return function (scope, element, attr) {
                      		...
                      		element.on('dragstart', function (event) {
                      			...
                      			var parent = element.parent("[dnd-list]");
                      			if (parent.length > 0)
                      				dndDragFrom.originList = $parse(parent[0].attributes["dnd-list"].value)(scope);
   ...
   */
  .directive('dndList', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround', '$window', 'dndDragFrom',
                 function ($parse, $timeout, dndDropEffectWorkaround, dndDragTypeWorkaround, $window, dndDragFrom) {
                 	return function (scope, element, attr) {
                 		...
                 		element.on('drop', function (event) {
                 			...
                 			if (targetArray == dndDragFrom.originList) {
                 				var origin = dndDragFrom.originList.indexOf(transferredObject);
                 				if (index > origin) {
                 					index--;
                 				}
                 				dndDragFrom.originList = undefined;
                 			}
                 			$timeout(function () {
  ...
  .factory('dndDropEffectWorkaround', function () { return {} })
	...
	.factory('dndDragFrom', function () { return { originList: undefined} });
